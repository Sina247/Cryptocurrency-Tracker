			...
			<div className="controls">
				<div className="filter-group">
					...
					<select value={sortBy} onChange={(e) => setSortBy(e.target.value)}>
						<option value="market_cap_rank" className="color-black">Rank</option>

						<option value="name" className="color-black">Name</option>

						<option value="price" className="color-black">Price (Low to High)</option>

						<option value="price_desc" className="color-black">Price (High to Low)</option>

						<option value="change" className="color-black">24h Change</option>

						<option value="market_cap" className="color-black">Market Cap</option>
					</select>
				</div>
